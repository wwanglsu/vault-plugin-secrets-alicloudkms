...
// pathConfig defines the alicloudkms/config base path on the backend.
func (b *backend) pathConfig() *framework.Path {
	fmt.Println("This is test on 4/16/2020-alicloudkms pathConfig()")
...
// pathConfigRead corresponds to READ alicloudkms/config and is used to
...
// pathConfigWrite corresponds to both CREATE and UPDATE alicloudkms/config and is
...
// pathConfigDelete corresponds to DELETE alicloudkms/config and is used to delete
