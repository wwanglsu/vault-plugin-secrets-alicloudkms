...
// pathKeysConfigRead corresponds to GET alicloudkms/keys/config/:name and is used to
...
// pathKeysConfigWrite corresponds to PUT/POST alicloudkms/keys/config/:key and
